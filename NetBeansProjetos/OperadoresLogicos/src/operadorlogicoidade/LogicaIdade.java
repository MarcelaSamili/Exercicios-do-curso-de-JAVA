 ...
 * @author Marcela
 */
public class LogicaIdade extends javax.swing.JFrame {

    /**
     * Creates new form LogicaIdade
     */
    public LogicaIdade() {
        initComponents();
    }
    ...
    private void btCalcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCalcActionPerformed
        ...
        String situacao = (idade>=18 && idade <=65)?"VOTO OBRIGATORIO":"NAO OBRIGATORIO";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LogicaIdade.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LogicaIdade().setVisible(true);
            }
        });
    }
